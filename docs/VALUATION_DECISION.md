...
3. Yahoo Finance - zrodlo propozycji ceny dla pojedynczego symbolu.
...
Po pobraniu ceny z Yahoo UI pokazuje preview. Dopiero zatwierdzenie zapisuje nowy `manualValuation`.
