...
/** Treść FAQ, wspólna dla wariantu publicznego (bez sesji) i osadzonego
 * w AppShell (zalogowany / tryb demo) — patrz app/faq/page.tsx, który
 * wybiera opakowanie w zależności od stanu sesji. */
