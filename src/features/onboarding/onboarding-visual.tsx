  ...
  return (
    <div aria-label="Animowany podgląd wyniku i struktury portfela" role="img" style={{ display: "grid", gridTemplateColumns: "minmax(0, 2fr) minmax(150px, 1fr)" }}>
      <div style={{ minWidth: 0, padding: "18px 18px 14px" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", color: V2.subtle, fontSize: 10, fontWeight: 700, letterSpacing: ".08em" }}>
          <span>1R</span><span>3L</span><span>5L</span><span>MAX</span>
        </div>
      </div>
      <div style={{ borderLeft: `1px solid ${V2.line}`, padding: "18px 14px", minWidth: 0 }}>
        <div style={{ color: V2.subtle, fontSize: 10, fontWeight: 700, letterSpacing: ".1em", textTransform: "uppercase" }}>Struktura aktywów</div>
        ...
        <div style={{ display: "grid", gap: 4, color: V2.muted, fontSize: 10, fontWeight: 600 }}>
